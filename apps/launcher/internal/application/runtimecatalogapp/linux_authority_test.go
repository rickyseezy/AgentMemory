...
func linuxManifest(t testing.TB) runtimecatalog.Manifest {
	...
	input := runtimecatalog.ManifestInput{
		...
		LinuxExecution: runtimecatalog.LinuxExecutionPolicyInput{
			...
			DockerCLISHA256:     runtimecatalog.DigestBytes([]byte("docker cli")),
			ComposePluginPath:   "/usr/libexec/docker/cli-plugins/docker-compose",
			ComposePluginSHA256: runtimecatalog.DigestBytes([]byte("compose plugin")),
			PrivilegeToolPath:   "/usr/bin/pkexec", PrivilegeToolSHA256: runtimecatalog.DigestBytes([]byte("pkexec")),
			PrivilegeToolPackage: "pkexec", PrivilegeToolPackageVersion: "124-2ubuntu1.24.04.3",
			PrivilegeToolPackageReceiptDigest: runtimecatalog.DigestBytes([]byte("pkexec package receipt")),
			HelperTools: []runtimecatalog.LinuxHelperToolInput{
				{Role: runtimecatalog.LinuxHelperToolAPTGet, Path: "/usr/bin/apt-get", SHA256: runtimecatalog.DigestBytes([]byte("apt-get")), Package: "apt", PackageVersion: "2.8.3", PackageReceiptDigest: runtimecatalog.DigestBytes([]byte("apt receipt"))},
				{Role: runtimecatalog.LinuxHelperToolDPKGQuery, Path: "/usr/bin/dpkg-query", SHA256: runtimecatalog.DigestBytes([]byte("dpkg-query")), Package: "dpkg", PackageVersion: "1.22.6ubuntu6.5", PackageReceiptDigest: runtimecatalog.DigestBytes([]byte("dpkg receipt"))},
				{Role: runtimecatalog.LinuxHelperToolLoginCTL, Path: "/usr/bin/loginctl", SHA256: runtimecatalog.DigestBytes([]byte("loginctl")), Package: "systemd", PackageVersion: "255.4-1ubuntu8.10", PackageReceiptDigest: runtimecatalog.DigestBytes([]byte("systemd receipt"))},
				{Role: runtimecatalog.LinuxHelperToolSystemCTL, Path: "/usr/bin/systemctl", SHA256: runtimecatalog.DigestBytes([]byte("systemctl")), Package: "systemd", PackageVersion: "255.4-1ubuntu8.10", PackageReceiptDigest: runtimecatalog.DigestBytes([]byte("systemd receipt"))},
			},
