...
func (c VerifiedCatalog) DesktopAuthority(
	...
	input := runtimeport.DesktopAuthorityInput{
		...
		DockerCLIPath: dockerCLI, ComposePluginPath: composePlugin,
		DockerCLISHA256:     runtimeinstall.Hash(execution.DockerCLISHA256()),
		ComposePluginSHA256: runtimeinstall.Hash(execution.ComposePluginSHA256()), ProbeImage: execution.ProbeImage(),
