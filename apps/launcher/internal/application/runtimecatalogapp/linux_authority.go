...
func (c VerifiedCatalog) LinuxAuthority(
	...
	input := runtimeport.LinuxAuthorityInput{
		...
		DockerCLIPath:               execution.DockerCLIPath(),
		DockerCLISHA256:             runtimeinstall.Hash(execution.DockerCLISHA256()),
		ComposePluginPath:           execution.ComposePluginPath(),
		ComposePluginSHA256:         runtimeinstall.Hash(execution.ComposePluginSHA256()),
		PrivilegeToolPath:           execution.PrivilegeToolPath(),
		PrivilegeToolSHA256:         runtimeinstall.Hash(execution.PrivilegeToolSHA256()),
		PrivilegeToolPackage:        execution.PrivilegeToolPackage(),
		PrivilegeToolPackageVersion: execution.PrivilegeToolPackageVersion(),
		...
		RPMKeysPackageReceiptDigest: runtimeinstall.Hash(
			execution.RPMKeysPackageReceiptDigest(),
		),
